"""
Usage:
    python get_messages_20.py <chat_id>
    python get_messages_20.py <index>   (index from chats.csv, starting at 1)
"""
import asyncio
import sys
...
async def main():
    if len(sys.argv) < 2:
        print("Usage: python get_messages_20.py <chat_id_or_index>")
        sys.exit(1)
    ...
    await fetch_and_print_messages(client, chat_id, limit=20)
    await client.disconnect()
